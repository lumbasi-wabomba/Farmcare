...
class SaleItems(models.Model):
    ...
    product = models.ForeignKey(Products, on_delete=models.PROTECT, related_name='sold_items')
    ...
    sales_clerk = models.ForeignKey(SalesClerk, on_delete=models.PROTECT, related_name='sales_by')
    date = models.DateField(auto_created=True)
    total_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    total_profit = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    total_cost = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    payment_method = models.ForeignKey(PaymentMethod, on_delete=models.PROTECT, related_name='sales_payment_type')
