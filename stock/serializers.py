...
class ProductsSerializer(serializers.ModelSerializer):
    category = serializers.SlugRelatedField(queryset=Category.objects.all(), slug_field='category_name', many=True, required=False)
    class Meta:
        model = Products
        fields = '__all__'
...
class PurchaseItemsSerializer(serializers.ModelSerializer):
    ...
    supplier = serializers.SlugRelatedField(queryset=Suppliers.objects.all(), slug_field='name', many=True, required=False)
    class Meta:
        model = PurchaseItems
        fields = '__all__'
