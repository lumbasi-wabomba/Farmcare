...
class Products(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, related_name='product_categories')
...
class PurchaseItems(models.Model):
    product= models.ForeignKey(Products, on_delete=models.SET_NULL, related_name='purchased_products')
    unit_BP = models.DecimalField(max_digits=8, decimal_places=2)
    no_of_Units = models.IntegerField()
    supplier = models.ForeignKey(Suppliers, on_delete=models.SET_NULL, related_name='items_from_suppliers')
